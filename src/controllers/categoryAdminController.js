...
const update = async (req, res) => {
    try {
        const result = await categoryAdminService.updateSystemCategory(req.params.categoryId, req.body);
        return res.status(result.statusCode).json(result);
    } catch (error) {
...
const remove = async (req, res) => {
    try {
        const result = await categoryAdminService.deleteSystemCategory(req.params.categoryId);
        return res.status(result.statusCode).json(result);
    } catch (error) {
